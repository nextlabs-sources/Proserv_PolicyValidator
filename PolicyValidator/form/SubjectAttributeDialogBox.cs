...
{
    public partial class SubjectAttributeDialogBox : Form
    {
        ...
        public SubjectAttributeDialogBox()
        {
            InitializeComponent();
        ...
        private void UpdateTextArea()
        {
            ...
            switch (ts)
            {
                case TargetSystem.Enovia:
                    attributeListTextArea.Text = Settings.Default.Enovia_Subject_Attributes.Replace(",", System.Environment.NewLine); ;
                    break;
                case TargetSystem.Sap:
                    attributeListTextArea.Text = Settings.Default.Sap_Subject_Attributes.Replace(",", System.Environment.NewLine); ;
                    break;
                case TargetSystem.Server:
                    attributeListTextArea.Text = Settings.Default.Server_Subject_Attributes.Replace(",", System.Environment.NewLine); ;
                    break;
                case TargetSystem.Portal:
                    attributeListTextArea.Text = Settings.Default.Portal_Subject_Attributes.Replace(",", System.Environment.NewLine); ;
                    break;
                case TargetSystem.Filesystem:
                    attributeListTextArea.Text = Settings.Default.Filesystem_Subject_Attributes.Replace(",", System.Environment.NewLine); ;
                    break;
            }
        }
    }
