...
{
    public partial class ResourceAttributeDialogBox : Form
    {
        ...
        public ResourceAttributeDialogBox()
        {
            InitializeComponent();
        ...
        private void UpdateTextArea()
        {
            ...
            switch (ts)
            {
                case TargetSystem.Enovia:
                    attributeListTextArea.Text = Settings.Default.Enovia_Resource_Attributes.Replace(",", System.Environment.NewLine); ;
                    break;
                case TargetSystem.Sap:
                    attributeListTextArea.Text = Settings.Default.Sap_Resource_Attributes.Replace(",", System.Environment.NewLine); ;
                    break;
                case TargetSystem.Server:
                    attributeListTextArea.Text = Settings.Default.Server_Resource_Attributes.Replace(",", System.Environment.NewLine); ;
                    break;
                case TargetSystem.Portal:
                    attributeListTextArea.Text = Settings.Default.Portal_Resource_Attributes.Replace(",", System.Environment.NewLine); ;
                    break;
                case TargetSystem.Filesystem:
                    attributeListTextArea.Text = Settings.Default.Filesystem_Resource_Attributes.Replace(",", System.Environment.NewLine); ;
                    break;
            }
        }
